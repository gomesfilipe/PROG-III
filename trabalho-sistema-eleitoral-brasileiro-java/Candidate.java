...
public class Candidate extends Person implements Comparable<Candidate> {
    ...
    //     output.printf("Nï¿½mero de vagas: %d\n\n", qtdElect);
    // }
    ...
    //     output.println("Candidatos mais votados (em ordem decrescente de votaï¿½ï¿½o e respeitando nï¿½mero de vagas):");
    ...
    //     output.println("Teriam sido eleitos se a votaï¿½ï¿½o fosse majoritï¿½ria, e nï¿½o foram eleitos:");
    //     output.println("(com sua posiï¿½ï¿½o no ranking de mais votados)");
    ...
    //     output.println("Eleitos, por faixa etï¿½ria (na data da eleiï¿½ï¿½o):");
